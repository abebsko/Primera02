...
"></script>
    ...
    <!-- Display Dates from Database -->
    <script>
        var dates = <?php echo json_encode($dates) ?>; //court hearings
        var dueDates = <?php echo json_encode($dueDates) ?>; // task due dates
